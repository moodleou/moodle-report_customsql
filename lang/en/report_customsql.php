...
$string['defaultperpage'] = 'Default # results per page';
$string['defaultperpage_desc'] = 'Default number od results per page to display in results view.';
...
$string['itemsperpage'] = '{$a} per page';
...
$string['perpage'] = 'Number of results per page';
$string['perpage_help'] = 'The maximum number of results to display per page (does not effect downloads)';
