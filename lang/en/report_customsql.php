...
$string['externalserviceallowed'] = 'Webservice access';
$string['externalserviceid'] = 'Binded webservice';
$string['externalservicedownloadallowed'] = 'Report could be downloaded using webservice';
