...
$string['customdir'] = 'Save file to directory';
$string['customdir_help'] = 'Files are saved in the CSV format. File names are of the format reportid-timecreated.csv';
...
$string['notadirectory'] = 'The path provided is not a directory.';
