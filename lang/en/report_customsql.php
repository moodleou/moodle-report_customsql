...
$string['errormissingconfig'] = 'Missing plugin config data.';
...
$string['max_records_desc'] = 'The maximum number of rows that can be returned by a query. Individual queries can have a lower limit set.';
$string['max_records_title'] = 'Max Records';
