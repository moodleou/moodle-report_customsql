...
class get_query_results extends \external_api {
    ...
    public static function execute(int $queryid, $format): array {
        ...
        $resultsdir = $CFG->dataroot . '/admin_report_customsql/temp/' . $queryid;
        $resultsdir = !empty($query->customdir) ? $query->customdir : $resultsdir;
        ...
        foreach ($files as $file) {
            ...
            $date = $query != 'manual' ? str_replace($queryid . '-', '', $filename) : $filename;
